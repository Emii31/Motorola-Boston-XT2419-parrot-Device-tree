...
BOARD_SUPER_PARTITION_SIZE := 7818182656 # Measured from stock super.img (sparse raw size)
BOARD_SUPER_PARTITION_GROUPS := motorola_dynamic_partitions
BOARD_MOTOROLA_DYNAMIC_PARTITIONS_PARTITION_LIST :=
BOARD_MOTOROLA_DYNAMIC_PARTITIONS_SIZE := 7813988352 # super - 4 MiB metadata
